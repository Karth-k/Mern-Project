        ...
        <div className="dropdown-menus">
          <div className="dropdown-categorys">
            <p>
              ...
              {isLoggedIn ? (
              <button onClick={() => logout()} className="dropdown-items"style={{ backgroundColor: "#FF5722",color: "white", borderRadius: "5px", padding: "10px", textAlign: "center", border: "none", cursor: "pointer"}}> 
              LOGOUT </button>
            ) : (
            ...
            <Link to="/lr-credits" className="dropdown-items"> LR CREDITS </Link> <hr />
            <Link to="/support" className="dropdown-items"> CUSTOMER SUPPORT </Link>
            <Link to="/faq" className="dropdown-items"> FAQ & HELP  </Link> <hr />
          </div>
        </div>
      )}
    </li>
